...
const char* ssid = "HITAM_G09";  // Enter SSID here
const char* password = "hitam@2023";  //Enter Password here

unsigned long myChannelNumber =2431378;
const char * myWriteAPIKey = "5ZJVNQ5SEZUTXO44";
WiFiClient  client;
...
void loop() {
  ...
  sendToThingSpeak(temperature, humidity, BPM, SpO2, bodytemperature);
...
void sendToThingSpeak(float temperature, float humidity, float BPM, float SpO2, float bodytemperature) {
  ThingSpeak.writeField(myChannelNumber, 1, temperature, myWriteAPIKey);
  ThingSpeak.writeField(myChannelNumber, 2, humidity, myWriteAPIKey);
  ThingSpeak.writeField(myChannelNumber, 3, BPM, myWriteAPIKey);
  ThingSpeak.writeField(myChannelNumber, 4, SpO2, myWriteAPIKey);
  ThingSpeak.writeField(myChannelNumber, 5, bodytemperature, myWriteAPIKey);
}
